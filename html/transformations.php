...
<div id="main-container">
    <div id="rows-container">
        <div id="top-menu-container">
            this is the top menu container
        </div>
...
<script>
    ...
    let steps = new Map([
        [
            'extractor-1', {'type': STEP_TYPE_EXTRACTOR, 'name': 'CSV', 'object': 'CsvExtractor'},
        ],
        [
        ...
        [
            'extractor-5', {'type': STEP_TYPE_EXTRACTOR, 'name': 'TXT', 'object': 'TxtExtractor'}
        ],
        [
            'transformer-1', {'type': STEP_TYPE_TRANSFORMER, 'name': 'Convert Case', 'object': 'ConvertCaseTransformer'}
        ],
        [
            'transformer-2', {'type': STEP_TYPE_TRANSFORMER, 'name': 'Guess Gender', 'object': 'GuessGenderTransformer'}
        ],
        [
